...
<div class="container">
    ...
    <div class="row justify-content-center d-flex align-items-center">
        <!-- <div class="col-md-10"> -->
        <div class="col text-center"><strong>Nazwa</strong></div>
    ...
    <div class="row justify-content-center d-flex align-items-center">
        ...
        <div class="col text-center"><a class="text-decoration-none fw-bold" href="{{ url('course', $course->id) }}?tab=about">{{ $course->name }} </a> </div>
    ...
    <div class="row justify-content-center d-flex align-items-center mt-3">
        <div class="col-6 text-center border-top pt-2">
            <span class="h5">Nie ma więcej kursów do wyświetlenia</span>
        </div>
    </div>
</div>
</div>
